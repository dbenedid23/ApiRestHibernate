...
public class UserService {
    ...
    @Path("/getAllUsersXML")  //http://localhost:8080/WebApplicationV2/resources/users/getAllUsersXML
    ...
    @GET  //el protocolo get.
    @Path("/getAllUsersJSON")  //http://localhost:8080/WebApplicationV2/resources/users/getAllUsersJSON
    @Produces(MediaType.APPLICATION_JSON)  //te produce algo de tipo xml.2
    ...
    @GET  //el protocolo get.
    @Path("/getUserByIdXML/{id}")  //http://localhost:8080/WebApplicationV2/resources/users/getUserByIdXML/1
    @Produces(MediaType.APPLICATION_XML)  //te produce algo de tipo xml.
    ...
    @GET  //el protocolo get.
    @Path("/getUserByIdJSON/{id}")  //http://localhost:8080/WebApplicationV2/resources/users/getUserByIdJSON/1
    ...
    @GET  //el protocolo get.
    @Path("/getUsersByYearBirthXML/{yearbirth}")  //http://localhost:8080/WebApplicationV2/resources/users/getUsersByYearBirthXML/2000
    @Produces(MediaType.APPLICATION_XML)  //te produce algo de tipo xml.
    ...
    @GET  //el protocolo get.
    @Path("/getUsersByYearBirthJSON/{yearbirth}")  //http://localhost:8080/WebApplicationV2/resources/users/getUsersByYearBirthJSON/2000
    @Produces(MediaType.APPLICATION_JSON)  //te produce algo de tipo xml.
    ...
    @Path("/post/createUserXML")  //http://localhost:8080/WebApplicationV2/resources/users/post/createUserXML
    @Produces(MediaType.APPLICATION_XML)  //te produce algo de tipo xml.
    ...
    @POST  //el protocolo get.
    @Path("/post/createUserJSON")  //http://localhost:8080/WebApplicationV2/resources/users/post/createUserJSON
